...
public class ObservableSubListTest {
    ...
    public void testLastIndexOf() {
        list = ObservableCollections.observableList(new ArrayList<String>());
    ...
    public void testConcurrencyAddAll() {
        list.add("x");
        try {
            sublist.addAll(Collections.singleton("y"));
        } catch (ConcurrentModificationException e) {
            return;
        }
        fail("Expected ConcurrentModificationException");
    ...
    public void testConcurrencyContainsAll() {
        list.add("x");
        try {
            sublist.containsAll(Collections.singletonList("x"));
        } catch (ConcurrentModificationException e) {
            return;
        }
        fail("Expected ConcurrentModificationException");
    ...
    public void testConcurrencyRemoveAll() {
        list.add("x");
        try {
            sublist.removeAll(Arrays.asList("c", "d"));
        } catch (ConcurrentModificationException e) {
            return;
        }
        fail("Expected ConcurrentModificationException");
    ...
    public void testConcurrencyRetainAll() {
        list.add("x");
        try {
            sublist.retainAll(Arrays.asList("c", "d"));
        } catch (ConcurrentModificationException e) {
            return;
        }
        fail("Expected ConcurrentModificationException");
