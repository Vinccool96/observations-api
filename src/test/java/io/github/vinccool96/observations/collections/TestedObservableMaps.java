...
public interface TestedObservableMaps {
    ...
    Callable<ObservableMap<String, String>> HASH_MAP =
            () -> ObservableCollections.observableMap(new HashMap<String, String>());
    ...
    Callable<ObservableMap<String, String>> LINKED_HASH_MAP =
            () -> ObservableCollections.observableMap(new LinkedHashMap<String, String>());
    ...
    Callable<ObservableMap<String, String>> SYNCHRONIZED_OBSERVABLE_HASH_MAP = () -> ObservableCollections
            .synchronizedObservableMap(ObservableCollections.observableMap(new HashMap<String, String>()));

    Callable<ObservableMap<String, String>> OBSERVABLE_MAP_PROPERTY =
            () -> new SimpleMapProperty<>(ObservableCollections.observableMap(new HashMap<String, String>()));
    ...
    static class CallableTreeMapImpl implements Callable<ObservableMap<String, String>> {
        ...
        public ObservableMap<String, String> call() throws Exception {
            return ObservableCollections.observableMap(new TreeMap<String, String>());
        }
    ...
    static class CallableConcurrentHashMapImpl implements Callable<ObservableMap<String, String>> {
        ...
        @Override
        public ObservableMap<String, String> call() throws Exception {
            return ObservableCollections.observableMap(new ConcurrentHashMap<String, String>());
        }
