...
public class ObservableCollectionsTest {
    ...
    public void concatTest() {
        ObservableList<String> seq =
                ObservableCollections.concat(ObservableCollections.observableArrayList("foo", "bar"),
                        ObservableCollections.observableArrayList("foobar"));
        assertArrayEquals(new String[]{"foo", "bar", "foobar"}, seq.toArray(new String[0]));
        seq = ObservableCollections.concat();
        assertTrue(seq.isEmpty());
        seq = ObservableCollections.concat(ObservableCollections.observableArrayList("foo"));
    ...
    public void shuffleTest() {
        ...
        ObservableList<String> seq = ObservableCollections.observableArrayList(content);
        for (int i = 0; i < 10; ++i) {
            ObservableCollections.shuffle(seq);
    ...
    public void copyTest() {
        ObservableList<String> dest = ObservableCollections.observableArrayList("a", "b", "c", "d");
        ObservableList<String> src = ObservableCollections.observableArrayList("foo", "bar");
        final MockListObserver<String> observer = new MockListObserver<String>();

        dest.addListener(observer);

        ObservableCollections.copy(dest, src);
    ...
    public void fillTest() {
        ObservableList<String> seq = ObservableCollections.observableArrayList("foo", "bar");
        final MockListObserver<String> observer = new MockListObserver<String>();

        seq.addListener(observer);
        ObservableCollections.fill(seq, "ham");
    ...
    public void replaceAllTest() {
        ObservableList<String> seq =
                ObservableCollections.observableArrayList("eggs", "ham", "spam", "spam", "eggs", "spam");
        final MockListObserver<String> observer = new MockListObserver<String>();

        seq.addListener(observer);
        ObservableCollections.replaceAll(seq, "spam", "viking");
        assertArrayEquals(new String[]{"eggs", "ham", "viking", "viking", "eggs", "viking"},
    ...
    public void reverseTest() {
        ...
        ObservableList<String> seq1 = ObservableCollections.observableArrayList("one", "two", "three", "four");
        final MockListObserver<String> observer1 = new MockListObserver<String>();
        seq1.addListener(observer1);

        ObservableList<String> seq2 = ObservableCollections.observableArrayList("one", "two", "three", "four", "five");
        final MockListObserver<String> observer2 = new MockListObserver<String>();
        seq2.addListener(observer2);

        ObservableCollections.reverse(seq1);
        ObservableCollections.reverse(seq2);
    ...
    public void rotateTest() {
        ObservableList<String> seq = ObservableCollections.observableArrayList("one", "two", "three", "four", "five");
        final MockListObserver<String> observer = new MockListObserver<String>();
        seq.addListener(observer);

        ObservableCollections.rotate(seq, 2);
        assertArrayEquals(new String[]{"four", "five", "one", "two", "three"}, seq.toArray(new String[0]));
        observer.check1();
        observer.clear();

        ObservableCollections.rotate(seq, 3);
        assertArrayEquals(new String[]{"one", "two", "three", "four", "five"}, seq.toArray(new String[0]));
        observer.check1();
        observer.clear();

        ObservableCollections.rotate(seq, 8);
    ...
    public void sortTest2() {
        ...
        final MockListObserver<String> observer = new MockListObserver<String>();
        seq.addListener(observer);
        ObservableCollections.sort(seq);
        observer.check1Permutation(seq, new int[]{4, 8, 0, 5, 6, 9, 7, 1, 2, 3});
        seq.setAll("q", "w", "e", "r", "t", "y", "u", "i", "o", "p");
        observer.clear();
        ObservableCollections.sort(seq, (o1, o2) -> o1.charAt(0) - o2.charAt(0));
        observer.check1Permutation(seq, new int[]{4, 8, 0, 5, 6, 9, 7, 1, 2, 3});
    }

    @Test
    public void sortTest_empty() {
        ObservableList<String> seq = ObservableCollections.observableArrayList();
        final MockListObserver<String> observer = new MockListObserver<String>();
        seq.addListener(observer);
        ObservableCollections.sort(seq);
        observer.check0();
    ...
    private void doSort(ObservableList<String> seq, boolean permutation) {
        ...
        observer.clear();
        ObservableCollections.sort(seq, (o1, o2) -> -o1.compareTo(o2));
    ...
    public void sortNotComparableTest() {
        ObservableList seq = ObservableCollections.observableArrayList(new Object(), new Object(), new Object());
        ObservableCollections.sort(seq);
    }

    @Test
    public void emptyObservableListTest() {
        ObservableList<String> seq = ObservableCollections.<String>emptyObservableList();
    ...
    public void singletonObservableListTest() {
        ObservableList<String> seq = ObservableCollections.singletonObservableList("foo");
    ...
    public void unmodifiableObservableListTest() {
        ObservableList<String> seq =
                ObservableCollections.unmodifiableObservableList(ObservableCollections.observableArrayList("foo"));
        testIfUnmodifiable(seq);
    }

    @Test
    public void unmodifiableObservableMapTest() {
        final ObservableMap<String, String> map = ObservableCollections.observableMap(new HashMap<String, String>());
        ObservableMap<String, String> om = ObservableCollections.unmodifiableObservableMap(map);
        map.put("foo", "bar");
    ...
    public void unmodifiableObservableMapTest_KeepsOrder() {
        final ObservableMap<Integer, Integer> map = ObservableCollections.observableMap(new TreeMap<>());
        ObservableMap<Integer, Integer> om = ObservableCollections.unmodifiableObservableMap(map);
        map.put(0, 0);
        map.put(1, 1);
        map.put(2, 2);
        map.put(3, 3);
    ...
    public void emptyObservableSetTest() {
        ObservableSet set = ObservableCollections.emptyObservableSet();
    ...
    public void unmodifiableObservableSetTest() {
        ObservableSet<String> set =
                ObservableCollections.unmodifiableObservableSet(ObservableCollections.observableSet("foo", "foo2"));
        try {
            set.add("foo3");
    ...
    public void checkedListenerObservableSetTest() {
        ObservableSet<String> set = ObservableCollections
                .checkedObservableSet(ObservableCollections.observableSet("foo", "foo2"), String.class);
    ...
    public void emptyObservableMapTest() {
        ObservableMap map = ObservableCollections.emptyObservableMap();
        assertEquals(0, map.size());
        assertTrue(map.isEmpty());
        assertFalse(map.containsKey("fooKey"));
        assertFalse(map.containsValue("fooValue"));
        assertEquals(null, map.get("fooKey"));
        assertEquals(ObservableCollections.emptyObservableSet(), map.values());
        assertEquals(ObservableCollections.emptyObservableSet(), map.keySet());
        assertEquals(ObservableCollections.emptyObservableSet(), map.entrySet());
    }

    @Test
    public void checkedObservableListTest() {
        ObservableList list = ObservableCollections
                .checkedObservableList(ObservableCollections.observableArrayList("foo", "foo2"), String.class);
        ...
        assertArrayEquals(
                new String[]{"foo0", "foo", "foo2", "foo2_1", "foo2_2", "foo3", "foo4", "foo5", "foo6", "foo7"},
                list.toArray(new String[0]));
        ...
        list.set(2, "fooNew2");
        assertArrayEquals(
                new String[]{"foo0", "foo", "fooNew2", "foo2_1", "foo2_2", "foo3", "foo4", "foo5", "foo6", "foo7"},
                list.toArray(new String[0]));
    ...
    public void checkedObservableMapTest() {
        final ObservableMap map = ObservableCollections.observableMap(new HashMap());
        ObservableMap om = ObservableCollections.checkedObservableMap(map, String.class, Boolean.class);
    ...
    public void checkedObservableSetTest() {
        ObservableSet set = ObservableCollections
                .checkedObservableSet(ObservableCollections.observableSet("foo", "foo2"), String.class);
