...
public class BindingsMapTest {
    ...
    public void setUp() {
        ...
        map1 = ObservableCollections.observableHashMap();
        map1.put(key1, data1);
        map1.put(key2, data2);
        map2 = ObservableCollections.observableHashMap();
    ...
    public void testBooleanValueAt_Constant() {
        ...
        final ObservableMap<String, Boolean> localMap1 = ObservableCollections.observableHashMap();
        localMap1.put(key1, localData1);
        localMap1.put(key2, localData2);
        final ObservableMap<String, Boolean> localMap2 = ObservableCollections.observableHashMap();
    ...
    public void testDoubleValueAt_Constant() {
        ...
        final ObservableMap<String, Double> localMap1 = ObservableCollections.observableHashMap();
        localMap1.put(key1, localData1);
        localMap1.put(key2, localData2);
        final ObservableMap<String, Double> localMap2 = ObservableCollections.observableHashMap();
    ...
    public void testFloatValueAt_Constant() {
        ...
        final ObservableMap<String, Float> localMap1 = ObservableCollections.observableHashMap();
        localMap1.put(key1, localData1);
        localMap1.put(key2, localData2);
        final ObservableMap<String, Float> localMap2 = ObservableCollections.observableHashMap();
    ...
    public void testIntegerValueAt_Constant() {
        ...
        final ObservableMap<String, Integer> localMap1 = ObservableCollections.observableHashMap();
        localMap1.put(key1, localData1);
        localMap1.put(key2, localData2);
        final ObservableMap<String, Integer> localMap2 = ObservableCollections.observableHashMap();
    ...
    public void testLongValueAt_Constant() {
        ...
        final ObservableMap<String, Long> localMap1 = ObservableCollections.observableHashMap();
        localMap1.put(key1, localData1);
        localMap1.put(key2, localData2);
        final ObservableMap<String, Long> localMap2 = ObservableCollections.observableHashMap();
    ...
    public void testStringValueAt_Constant() {
        ...
        final ObservableMap<String, String> localMap1 = ObservableCollections.observableHashMap();
        localMap1.put(key1, localData1);
        localMap1.put(key2, localData2);
        final ObservableMap<String, String> localMap2 = ObservableCollections.observableHashMap();
