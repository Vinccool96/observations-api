...
import io.github.vinccool96.observations.beans.value.ObservableStringValueStub;
...
@SuppressWarnings("SimplifiableJUnitAssertion") public class StringPropertyBaseTest {
    ...
    public void testToString() {
        ...
        assertEquals("StringProperty [bean: " + bean.toString() + ", name: My name, value: " + null + "]",
                v1.toString());
        v1.set(value1);
        assertEquals("StringProperty [bean: " + bean.toString() + ", name: My name, value: " + value1 + "]",
                v1.toString());
