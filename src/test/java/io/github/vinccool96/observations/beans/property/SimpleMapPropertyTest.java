...
public class SimpleMapPropertyTest {
    ...
    private static final ObservableMap<Object, Object> VALUE_1 =
            ObservableCollections.observableHashMap(new Pair<Object, Object>(new Object(), new Object()));

    @Test
    public void testConstructor_NoArguments() {
        final MapProperty<Object, Object> v = new SimpleMapProperty<Object, Object>();
    ...
    public void testConstructor_InitialValue() {
        ...
        final MapProperty<Object, Object> v2 = new SimpleMapProperty<Object, Object>(DEFAULT_VALUE);
    ...
    public void testConstructor_Bean_Name() {
        ...
        final MapProperty<Object, Object> v = new SimpleMapProperty<Object, Object>(bean, name);
        assertEquals(bean, v.getBean());
        assertEquals(name, v.getName());
        assertEquals(DEFAULT_VALUE, v.get());

        final MapProperty<Object, Object> v2 = new SimpleMapProperty<Object, Object>(bean, null);
    ...
    public void testConstructor_Bean_Name_InitialValue() {
        final Object bean = new Object();
        final String name = "My name";
        final MapProperty<Object, Object> v1 = new SimpleMapProperty<Object, Object>(bean, name, VALUE_1);
        assertEquals(bean, v1.getBean());
        assertEquals(name, v1.getName());
        assertEquals(VALUE_1, v1.get());

        final MapProperty<Object, Object> v2 = new SimpleMapProperty<Object, Object>(bean, name, DEFAULT_VALUE);
        assertEquals(bean, v2.getBean());
        assertEquals(name, v2.getName());
        assertEquals(DEFAULT_VALUE, v2.get());

        final MapProperty<Object, Object> v3 = new SimpleMapProperty<Object, Object>(bean, null, VALUE_1);
        assertEquals(bean, v3.getBean());
        assertEquals(DEFAULT_NAME, v3.getName());
        assertEquals(VALUE_1, v3.get());

        final MapProperty<Object, Object> v4 = new SimpleMapProperty<Object, Object>(bean, null, DEFAULT_VALUE);
