...
public class ReadOnlyLongWrapperTest {
    ...
    public void testToString() {
        ...
        assertEquals("LongProperty [bean: " + bean.toString() + ", name: My name, value: " + DEFAULT + "]",
                v2.toString());
        ...
        assertEquals("ReadOnlyLongProperty [bean: " + bean.toString() + ", value: " + DEFAULT + "]",
        ...
        assertEquals("ReadOnlyLongProperty [name: My name, value: " + DEFAULT + "]",
