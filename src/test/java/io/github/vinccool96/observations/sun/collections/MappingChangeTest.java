...
public class MappingChangeTest {
    ...
    @Before
    public void setUp() {
        originalList = ObservableCollections.observableArrayList(1, 2, 3, 4, 5);
        list = ObservableCollections.observableArrayList("1", "2", "3", "4", "5");
    }
    ...
    public void testPermutation() {
        Change<Integer> change =
                new NonIterableChange.SimplePermutationChange<Integer>(0, 2, new int[]{1, 0}, originalList);
        MappingChange<Integer, String> mapChange = new MappingChange<Integer, String>(change,
                e -> e.toString(), list);
