...
public class MapListenerHelperTest {
    ...
    public void setUp() {
        ...
        helper = null;
        map = ObservableCollections.observableHashMap();
    ...
    public void testExceptionNotPropagatedFromSingleInvalidation() {
        helper = MapListenerHelper.addListener(helper, (Observable o) -> {
    ...
    public void testExceptionNotPropagatedFromSingleChange() {
        helper = MapListenerHelper
                .addListener(helper, (MapChangeListener.Change<? extends Object, ? extends Object> c) -> {
                    throw new RuntimeException();
                });
        helper.fireValueChangedEvent(change);
    }
