...
public class JavaBeanPropertyBuilderHelperTest {
    ...
    @Test
    public void testReusabilityWhenChangeOfBeanClass()
    ...
    public static class POJOBeanWithNonStandardNames {
        ...
        public POJOBeanWithNonStandardNames(Object x) {
            this.x = x;
        }
