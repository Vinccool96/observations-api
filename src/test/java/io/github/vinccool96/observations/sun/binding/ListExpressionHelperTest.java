...
import io.github.vinccool96.observations.beans.value.WeakChangeListenerMock;
...
//    private ListChangeListener.Change change_2_1;
    ...
    public void setUp() {
        listItem = new Object();
        data1 = ObservableCollections.observableArrayList();
        data2 = ObservableCollections.observableArrayList(listItem);
        data3 = ObservableCollections.observableArrayList(listItem);
...
//        change_2_1 = new NonIterableChange.SimpleRemovedChange(0, 1, listItem, data1);
        ...
        listChangeListener = new MockListObserver[]{
                new MockListObserver<Object>(), new MockListObserver<Object>(), new MockListObserver<Object>(),
    ...
    public void testEmpty() {
        final ListChangeListener.Change change =
                new NonIterableChange.SimpleRemovedChange(0, 1, new Object(), observable);
    ...
    public void testSingleInvalidation() {
        ...
        ListExpressionHelper
                .fireValueChangedEvent(helper, new NonIterableChange.SimpleRemovedChange(0, 1, listItem, data2));
        invalidationListener[0].check(observable, 1);
        data2.add(listItem);
        ...
        ListExpressionHelper.fireValueChangedEvent(helper);
        invalidationListener[0].check(observable, 1);
        listChangeListener[1].check1AddRemove(observable, ObservableCollections.emptyObservableList(), 0, 1);
    ...
    public void testSingleListChange() {
        ...
        observable.set(data2);
        ListExpressionHelper.fireValueChangedEvent(helper);
        listChangeListener[0].check1AddRemove(observable, ObservableCollections.emptyObservableList(), 0, 1);
        listChangeListener[0].clear();

        data2.remove(0);
        ListExpressionHelper
                .fireValueChangedEvent(helper, new NonIterableChange.SimpleRemovedChange(0, 0, listItem, data2));
        listChangeListener[0]
                .check1AddRemove(observable, ObservableCollections.singletonObservableList(listItem), 0, 0);
        listChangeListener[0].clear();
        data2.add(listItem);
        ...
        final ChangeListener<Object> addingListener = new ChangeListener() {
            ...
            @Override public void changed(ObservableValue observable, Object oldValue, Object newValue) {
                if (index < invalidationListener.length) {
                    helper = ListExpressionHelper.addListener(helper, ListExpressionHelperTest.this.observable,
                            invalidationListener[index++]);
                }
            }
        };
    ...
    public void testAddChangeWhileLocked() {
        final InvalidationListener addingListener = new InvalidationListener() {
            ...
            @Override public void invalidated(Observable observable) {
                if (index < invalidationListener.length) {
                    helper = ListExpressionHelper
                            .addListener(helper, ListExpressionHelperTest.this.observable, changeListener[index++]);
                }
            }
        };
        helper = ListExpressionHelper.addListener(helper, observable, addingListener);
    ...
    public void testAddListChange() {
        ...
        listChangeListener[1].check1AddRemove(observable, ObservableCollections.emptyObservableList(), 0, 1);
        listChangeListener[1].clear();
        listChangeListener[2].check1AddRemove(observable, ObservableCollections.emptyObservableList(), 0, 1);
    ...
    public void testAddListChangeWhileLocked() {
        final InvalidationListener addingListener = new InvalidationListener() {
            ...
            @Override public void invalidated(Observable observable) {
                if (index < invalidationListener.length) {
                    helper = ListExpressionHelper
                            .addListener(helper, ListExpressionHelperTest.this.observable, listChangeListener[index++]);
                }
            }
        };
        helper = ListExpressionHelper.addListener(helper, observable, addingListener);
        ...
        listChangeListener[1].check1AddRemove(observable, ObservableCollections.emptyObservableList(), 0, 1);
        listChangeListener[2].check1AddRemove(observable, ObservableCollections.emptyObservableList(), 0, 1);
        listChangeListener[3].check1AddRemove(observable, ObservableCollections.emptyObservableList(), 0, 1);
    }
    ...
    public void testFireValueChangedEvent() {
        ...
        listChangeListener[0].check1AddRemove(observable, ObservableCollections.emptyObservableList(), 0, 0);
        listChangeListener[0].clear();
