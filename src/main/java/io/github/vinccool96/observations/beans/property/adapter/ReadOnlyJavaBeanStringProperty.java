...
import io.github.vinccool96.observations.beans.property.ReadOnlyStringPropertyBase;
...
/**
 * A {@code ReadOnlyJavaBeanStringProperty} provides an adapter between a regular read only Java Bean property of type
 * {@code String} and a JavaFX {@code ReadOnlyStringProperty}. It cannot be created directly, but a {@link
 ...
 * PropertyChangeListeners), this {@code ReadOnlyJavaBeanStringProperty} will be aware of changes in the Java Bean.
