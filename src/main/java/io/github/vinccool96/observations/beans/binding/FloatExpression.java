...
/**
 * A {@code FloatExpression} is a {@link ObservableFloatValue} plus additional convenience methods to generate bindings
 * in a fluent style.
 * <p>
...
public abstract class FloatExpression extends NumberExpressionBase implements ObservableFloatValue {
    ...
    /**
     * Returns a {@code FloatExpression} that wraps a {@link ObservableFloatValue}. If the {@code ObservableFloatValue}
     * is already a {@code FloatExpression}, it will be returned. Otherwise a new {@link FloatBinding} is created that
     * is bound to the {@code ObservableFloatValue}.
     *
     * @param value
     *         The source {@code ObservableFloatValue}
     *
     * @return A {@code FloatExpression} that wraps the {@code ObservableFloatValue} if necessary
     *
    ...
    /**
     * Returns a {@code FloatExpression} that wraps an {@link ObservableValue}. If the {@code ObservableValue} is
     * already a {@code FloatExpression}, it will be returned. Otherwise a new {@link FloatBinding} is created that is
     * bound to the {@code ObservableValue}.
     *
     * <p>
     * Note: this method can be used to convert an {@link ObjectExpression} or {@link
     * io.github.vinccool96.observations.beans.property.ObjectProperty} of specific number type to FloatExpression,
    ...
    /**
     * Creates an {@link ObjectExpression} that holds the value of this {@code FloatExpression}. If the value of this
     * {@code FloatExpression} changes, the value of the {@code ObjectExpression} will be updated automatically.
     *
