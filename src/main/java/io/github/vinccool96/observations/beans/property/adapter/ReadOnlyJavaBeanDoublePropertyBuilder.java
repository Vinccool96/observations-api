...
/**
 * A {@code ReadOnlyJavaBeanDoublePropertyBuilder} can be used to create {@link ReadOnlyJavaBeanDoubleProperty
 * ReadOnlyJavaBeanDoubleProperties}. To create a {@code ReadOnlyJavaBeanDoubleProperty} one first has to call {@link
 ...
 * ReadOnlyJavaBeanDoublePropertyBuilder}. by switching the Java Bean instance (with {@link #bean(Object)} and calling
 * {@link #build()}.
 *
