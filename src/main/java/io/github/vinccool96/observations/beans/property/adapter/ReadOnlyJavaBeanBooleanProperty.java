...
/**
 * A {@code ReadOnlyJavaBeanBooleanProperty} provides an adapter between a regular read only Java Bean property of type
 * {@code boolean} or {@code Boolean} and a JavaFX {@code ReadOnlyBooleanProperty}. It cannot be created directly, but a
 ...
 * PropertyChangeListeners), this {@code ReadOnlyJavaBeanBooleanProperty} will be aware of changes in the Java Bean.
 * Otherwise it can be notified about changes by calling {@link #fireValueChangedEvent()}.
 *
 * @see io.github.vinccool96.observations.beans.property.ReadOnlyBooleanProperty
 * @see ReadOnlyJavaBeanBooleanPropertyBuilder
 */
public final class ReadOnlyJavaBeanBooleanProperty extends ReadOnlyBooleanPropertyBase implements
