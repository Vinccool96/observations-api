...
/**
 * Base class that provides most of the functionality needed to implement a {@link Binding} of a {@code float} value.
 * <p>
 * {@code FloatBinding} provides a simple invalidation-scheme. An extending class can register dependencies by calling
 * {@link #bind(Observable...)}. If one of the registered dependencies becomes invalid, this {@code FloatBinding} is
...
public abstract class FloatBinding extends FloatExpression implements NumberBinding {
     ...
     * <p>
     * Classes extending {@code FloatBinding} have to provide an implementation of {@code computeValue}.
     *
