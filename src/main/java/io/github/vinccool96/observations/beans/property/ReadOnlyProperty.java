...
public interface ReadOnlyProperty<T> extends ObservableValue<T> {
    ...
    /**
     * Returns the {@code Object} that contains this property. If this property is not contained in an {@code Object},
    ...
    /**
     * Returns the name of this property. If the property does not have a name, this method returns an empty {@code
     * String}.
     *
