...
import io.github.vinccool96.observations.beans.binding.LongBinding;
...
/**
 * The class {@code LongPropertyBase} is the base class for a property wrapping a {@code long} value.
 * <p>
...
public abstract class LongPropertyBase extends LongProperty {
     ...
     * ChangeListeners}.
     * <p>
     * This method is called when the value is changed, either manually by calling {@link #set(long)} or in case of a
