...
import static io.github.vinccool96.observations.collections.SetChangeListener.Change;
...
public class ReadOnlySetWrapper<E> extends SimpleSetProperty<E> {
    ...
    /**
     * Returns the readonly property, that is synchronized with this {@code ReadOnlySetWrapper}.
     *
