...
import io.github.vinccool96.observations.beans.value.WritableFloatValue;
 ...
 * <p>
 * The value of a {@code FloatProperty} can be get and set with {@link #get()}, {@link #getValue()}, {@link
 * #set(float)}, and {@link #setValue(Number)}.
 * <p>
...
public abstract class FloatProperty extends ReadOnlyFloatProperty implements Property<Number>, WritableFloatValue {
     ...
     *
     * @return A {@code FloatProperty} that wraps the {@code Property}
     *
