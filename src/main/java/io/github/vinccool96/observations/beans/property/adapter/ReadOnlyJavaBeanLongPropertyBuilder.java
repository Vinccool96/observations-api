...
/**
 * A {@code ReadOnlyJavaBeanLongPropertyBuilder} can be used to create {@link ReadOnlyJavaBeanLongProperty
 * ReadOnlyJavaBeanLongProperties}. To create a {@code ReadOnlyJavaBeanLongProperty} one first has to call {@link
 ...
 * ReadOnlyJavaBeanLongPropertyBuilder}. by switching the Java Bean instance (with {@link #bean(Object)} and calling
 * {@link #build()}.
 *
...
public final class ReadOnlyJavaBeanLongPropertyBuilder {
     ...
     *         if the Java Bean property is not of type {@code long} or {@code Long}
     */
