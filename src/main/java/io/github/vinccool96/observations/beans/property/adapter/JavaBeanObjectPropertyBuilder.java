...
/**
 * A {@code JavaBeanObjectPropertyBuilder} can be used to create {@link JavaBeanObjectProperty
 * JavaBeanObjectProperties}. To create a {@code JavaBeanObjectProperty} one first has to call {@link #create()} to
