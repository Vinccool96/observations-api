...
import io.github.vinccool96.observations.beans.value.ObservableListValue;
...
/**
 * A {@code ListExpression} is a {@link ObservableListValue} plus additional convenience methods to generate bindings in
 * a fluent style.
 * <p>
 * A concrete sub-class of {@code ListExpression} has to implement the method {@link ObservableListValue#get()}, which
 * provides the actual value of this expression.
 * <p>
 * If the wrapped list of a {@code ListExpression} is {@code null}, all methods implementing the {@code List} interface
...
public abstract class ListExpression<E> implements ObservableListValue<E> {
    ...
    /**
     * Returns a {@code ListExpression} that wraps a {@link ObservableListValue}. If the {@code ObservableListValue} is
     * already a {@code ListExpression}, it will be returned. Otherwise a new {@link ListBinding} is created that is
     * bound to the {@code ObservableListValue}.
     *
     * @param value
    ...
    /**
     * Creates a new {@link ObjectBinding} that contains the element at the specified position. If {@code index} points
     * behind the list, the {@code ObjectBinding} contains {@code null}.
     *
     * @param index
    ...
    /**
     * Creates a new {@link ObjectBinding} that contains the element at the specified position. If {@code index} points
     * outside of the list, the {@code ObjectBinding} contains {@code null}.
     *
     * @param index
     *         the index of the element
     *
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this list is not equal to another {@link
     * ObservableList}.
     *
     * @param other
     *         the other {@code ObservableList}
    ...
    /**
     * Creates a {@link StringBinding} that holds the value of the {@code ListExpression} turned into a {@code String}.
     * If the value of this {@code ListExpression} changes, the value of the {@code StringBinding} will be updated
     * automatically.
     *
