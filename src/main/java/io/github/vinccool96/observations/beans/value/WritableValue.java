...
/**
 * A {@code WritableValue} is an entity that wraps a value that can be read and set. In general this interface should
 * not be implemented directly but one of its sub-interfaces ({@code WritableBooleanValue} etc.).
 *
 * @param <T>
