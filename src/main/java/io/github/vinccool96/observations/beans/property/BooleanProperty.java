...
import io.github.vinccool96.observations.beans.value.WritableBooleanValue;
import io.github.vinccool96.observations.sun.binding.BidirectionalBinding;
import io.github.vinccool96.observations.sun.binding.Logging;
 ...
 * <p>
 * The value of a {@code BooleanProperty} can be get and set with {@link #get()}, {@link #getValue()}, {@link
 * #set(boolean)}, and {@link #setValue(Boolean)}.
 * <p>
...
public abstract class BooleanProperty extends ReadOnlyBooleanProperty
    ...
    /**
     * Returns a {@code BooleanProperty} that wraps a {@link Property}. If the {@code Property} is already a {@code
     * BooleanProperty}, it will be returned. Otherwise a new {@code BooleanProperty} is created that is bound to the
     * {@code Property}.
     * <p>
     ...
     *
     * @return A {@code BooleanProperty} that wraps the {@code Property} if necessary
     *
    ...
    /**
     * Creates an {@link ObjectProperty} that holds the value of this {@code BooleanProperty}. If the value of this
