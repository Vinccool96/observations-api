...
import io.github.vinccool96.observations.beans.value.ObservableStringValue;
...
public abstract class StringExpression implements ObservableStringValue {
    ...
    /**
     * Returns usually the value of this {@code StringExpression}. Only if the value is {@code null} an empty {@code
    ...
    /**
     * Returns a {@code StringExpression} that holds the value of this {@code StringExpression} concatenated with
     * another {@code Object}.
     * <p>
     * If the value of this {@code StringExpression} changes, the value of the resulting {@code StringExpression} is
     * updated automatically. Also if the other {@code Object} is an implementation of {@link ObservableValue}, changes
     * in the other {@code Object} are reflected automatically in the resulting {@code StringExpression}.
     *
     * @param other
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code StringExpression} is {@code null}.
     *
     * @return the new {@code BooleanBinding}
     */
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code StringExpression} is not {@code
     * null}.
     *
     * @return the new {@code BooleanBinding}
     */
    ...
    /**
     * Creates a new {@link IntegerBinding} that holds the length of this {@code StringExpression}.
     * <p>
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code StringExpression} is empty.
     * <p>
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code StringExpression} is not empty.
     * <p>
     * Note: If the value of this {@code StringExpression} is {@code null}, it is considered to be empty.
     *
     * @return the new {@code BooleanBinding}
