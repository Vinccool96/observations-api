...
/**
 * The class {@code ListPropertyBase} is the base class for a property wrapping an {@link ObservableList}.
 * <p>
...
public abstract class ListPropertyBase<E> extends ListProperty<E> {
     ...
     * <p>
     * This method is called when the value is changed, either manually by calling {@link #set(ObservableList)} or in
