 ...
 * <p>
 * A ternary expression has the basic form {@code new When(cond).then(value1).otherwise(value2);}. The expression {@code
 * cond} needs to be a {@link ObservableBooleanValue}. Based on the value of {@code cond}, the binding contains the
...
public class When {
    ...
    private static class WhenListener implements InvalidationListener {
        ...
        public void invalidated(Observable observable) {
            ...
            if (binding == null) {
                ...
                // active branch.
                if (condition.equals(observable) ||
                        (binding.isValid() && (condition.get() == observable.equals(thenValue)))) {
                    binding.invalidate();
                }
            }
        }
        ...
        if ((thenValue instanceof ObservableDoubleValue) || (otherwiseValue instanceof ObservableDoubleValue)) {
            return new DoubleBinding() {
                ...
                protected double computeValue() {
                    ...
                    Logging.getLogger()
                            .finest("Condition of ternary binding expression was evaluated: {0}", conditionValue);
                ...
                public ObservableList<ObservableValue<?>> getDependencies() {
                    return ObservableCollections.unmodifiableObservableList(
                            ObservableCollections.<ObservableValue<?>>observableArrayList(condition, thenValue,
                                    otherwiseValue));
                }
            };
    ...
    public class NumberConditionBuilder {
        ...
        /**
         * Defines the {@link ObservableNumberValue} which value is returned by the ternary expression if the condition
         * is {@code false}.
         *
        ...
        /**
         * Defines a constant value of the ternary expression, that is returned if the condition is {@code false}.
         *
         * @param otherwiseValue
         *         the value
         *
    ...
    /**
     * Defines the {@link ObservableNumberValue} which value is returned by the ternary expression if the condition is
     * {@code true}.
     *
     * @param thenValue
     *         the value
    ...
    private class BooleanCondition extends BooleanBinding {
        ...
        public ObservableList<ObservableValue<?>> getDependencies() {
            ...
            final ObservableList<ObservableValue<?>> seq =
                    ObservableCollections.<ObservableValue<?>>observableArrayList(condition);
            if (trueResult != null) {
                seq.add(trueResult);
            }
            if (falseResult != null) {
            ...
            return ObservableCollections.unmodifiableObservableList(seq);
        }
    ...
    public class BooleanConditionBuilder {
        ...
        /**
         * Defines the {@link ObservableBooleanValue} which value is returned by the ternary expression if the condition
         * is {@code false}.
         *
         * @param otherwiseValue
         *         the value
    ...
    /**
     * Defines the {@link ObservableBooleanValue} which value is returned by the ternary expression if the condition is
     * {@code true}.
     *
     * @param thenValue
     *         the value
    ...
    public class StringConditionBuilder {
        ...
        /**
         * Defines the {@link ObservableStringValue} which value is returned by the ternary expression if the condition
         * is {@code false}.
         *
         * @param otherwiseValue
         *         the value
    ...
    /**
     * Defines the {@link ObservableStringValue} which value is returned by the ternary expression if the condition is
     * {@code true}.
     *
     * @param thenValue
     *         the value
    ...
    public class ObjectConditionBuilder<T> {
        ...
        /**
         * Defines the {@link ObservableObjectValue} which value is returned by the ternary expression if the condition
         * is {@code false}.
         *
         * @param otherwiseValue
         *         the value
