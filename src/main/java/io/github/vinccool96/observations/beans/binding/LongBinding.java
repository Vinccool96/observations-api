...
/**
 * Base class that provides most of the functionality needed to implement a {@link Binding} of a {@code long} value.
 * <p>
 * {@code LongBinding} provides a simple invalidation-scheme. An extending class can register dependencies by calling
 * {@link #bind(Observable...)}. If One of the registered dependencies becomes invalid, this {@code LongBinding} is
