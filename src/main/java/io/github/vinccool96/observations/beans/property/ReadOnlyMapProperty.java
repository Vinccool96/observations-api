...
import io.github.vinccool96.observations.beans.binding.MapExpression;
...
public abstract class ReadOnlyMapProperty<K, V> extends MapExpression<K, V> implements
    ...
    /**
     * Creates a bidirectional content binding of the {@link ObservableMap}, that is wrapped in this {@code
     * ReadOnlyMapProperty}, and another {@code ObservableMap}.
     * <p>
     * A bidirectional content binding ensures that the content of two {@code ObservableMaps} is the same. If the
     * content of one of the maps changes, the other one will be updated automatically.
     *
     * @param map
     ...
     *         if {@code map} is the same map that this {@code ReadOnlyMapProperty} points to
     */
    ...
    /**
     * Deletes a bidirectional content binding between the {@link ObservableMap}, that is wrapped in this {@code
     * ReadOnlyMapProperty}, and another {@code Object}.
     *
     * @param object
     ...
     * @throws IllegalArgumentException
     *         if {@code object} is the same map that this {@code ReadOnlyMapProperty} points to
     */
    ...
    /**
     * Creates a content binding between the {@link ObservableMap}, that is wrapped in this {@code ReadOnlyMapProperty},
