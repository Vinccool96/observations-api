...
/**
 * A {@code NumberExpression} is a {@link ObservableNumberValue} plus additional convenience methods to generate
...
public interface NumberExpression extends ObservableNumberValue {
    ...
    /**
     * Creates a new {@link NumberBinding} that calculates the negation of {@code NumberExpression}.
     *
    ...
    /**
     * Creates a new {@link NumberBinding} that calculates the sum of this {@code NumberExpression} and another {@link
    ...
    /**
     * Creates a new {@link NumberBinding} that calculates the sum of this {@code NumberExpression} and a constant
     * value.
     *
     * @param other
     *         the constant value
    ...
    /**
     * Creates a new {@link NumberBinding} that calculates the difference of this {@code NumberExpression} and another
    ...
    /**
     * Creates a new {@link NumberBinding} that calculates the difference of this {@code NumberExpression} and a
     * constant value.
     *
     * @param other
     *         the constant value
    ...
    /**
     * Creates a new {@link NumberBinding} that calculates the product of this {@code NumberExpression} and another
     * {@link ObservableNumberValue}.
     *
     * @param other
     *         the second {@code ObservableNumberValue}
    ...
    /**
     * Creates a new {@link NumberBinding} that calculates the product of this {@code NumberExpression} and a constant
     * value.
     *
     * @param other
     *         the constant value
    ...
    /**
     * Creates a new {@link NumberBinding} that calculates the division of this {@code NumberExpression} and another
     * {@link ObservableNumberValue}.
     *
     * @param other
     *         the second {@code ObservableNumberValue}
    ...
    /**
     * Creates a new {@link NumberBinding} that calculates the division of this {@code NumberExpression} and a constant
     * value.
     *
     * @param other
     *         the constant value
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this and another {@link ObservableNumberValue}
     * are equal.
     * <p>
     * When comparing floating-point numbers it is recommended to use the {@link #isEqualTo(ObservableNumberValue,
     * double) isEqualTo()} method that allows a small tolerance.
     *
     * @param other
     *         the second {@code ObservableNumberValue}
     *
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code NumberExpression} is equal to a
     ...
     * constant value.
     * <p>
     * When comparing floating-point numbers it is recommended to use the {@link #isEqualTo(long, double) isEqualTo()}
     ...
     * constant value.
     * <p>
     * When comparing floating-point numbers it is recommended to use the {@link #isEqualTo(int, double) isEqualTo()}
     * method that allows a small tolerance.
     *
     * @param other
     *         the constant value
     ...
     * are not equal.
     * <p>
     * When comparing floating-point numbers it is recommended to use the {@link #isNotEqualTo(ObservableNumberValue,
     * double) isNotEqualTo()} method that allows a small tolerance.
     *
     * @param other
     *         the second {@code ObservableNumberValue}
     *
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code NumberExpression} is not equal to a
     * constant value (with a tolerance).
     * <p>
     * Two operands {@code a} and {@code b} are considered not equal if {@code Math.abs(a-b) > epsilon}.
     * <p>
     ...
     * constant value.
     * <p>
     * When comparing floating-point numbers it is recommended to use the {@link #isNotEqualTo(long, double)
     * isNotEqualTo()} method that allows a small tolerance.
     *
     * @param other
     *         the constant value
     *
     ...
     * constant value.
     * <p>
     * When comparing floating-point numbers it is recommended to use the {@link #isNotEqualTo(int, double)
     * isNotEqualTo()} method that allows a small tolerance.
     *
     * @param other
     *         the constant value
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code NumberExpression} is greater than
     * another {@link ObservableNumberValue}.
     *
     * @param other
     *         the second {@code ObservableNumberValue}
     *
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code NumberExpression} is greater than a
     * constant value.
     *
     * @param other
     *         the constant value
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code NumberExpression} is lesser than
     * another {@link ObservableNumberValue}.
     *
     * @param other
     *         the second {@code ObservableNumberValue}
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code NumberExpression} is lesser than a
     * constant value.
     *
     * @param other
     *         the constant value
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code NumberExpression} is greater than or
     * equal to another {@link ObservableNumberValue}.
     *
     * @param other
     *         the second {@code ObservableNumberValue}
     *
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code NumberExpression} is less than or
     * equal to another {@link ObservableNumberValue}.
     *
     * @param other
     *         the second {@code ObservableNumberValue}
    ...
    /**
     * Creates a {@link StringBinding} that holds the value of the {@code NumberExpression} turned into a {@code
     * String}. If the value of this {@code NumberExpression} changes, the value of the {@code StringBinding} will be
     ...
     * updated automatically.
     * <p>
     * The result is formatted according to the formatting {@code String}. See {@code java.util.Formatter} for
     * formatting rules.
     *
     * @param format
