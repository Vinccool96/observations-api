...
import static io.github.vinccool96.observations.collections.MapChangeListener.Change;
...
public class ReadOnlyMapWrapper<K, V> extends SimpleMapProperty<K, V> {
    ...
    /**
     * Returns the readonly property, that is synchronized with this {@code ReadOnlyMapWrapper}.
     *
