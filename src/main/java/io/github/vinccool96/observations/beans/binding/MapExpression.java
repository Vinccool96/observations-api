...
/**
 * A {@code MapExpression} is a {@link ObservableMapValue} plus additional convenience methods to generate bindings in a
 * fluent style.
 * <p>
 * A concrete sub-class of {@code MapExpression} has to implement the method {@link ObservableMapValue#get()}, which
...
public abstract class MapExpression<K, V> implements ObservableMapValue<K, V> {
    ...
    /**
     * Returns a {@code MapExpression} that wraps a {@link ObservableMapValue}. If the {@code ObservableMapValue} is
     * already a {@code MapExpression}, it will be returned. Otherwise a new {@link MapBinding} is created that is bound
     * to the {@code ObservableMapValue}.
     *
     * @param value
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this map is equal to another {@link
     * ObservableMap}.
     *
     * @param other
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this map is not equal to another {@link
     * ObservableMap}.
     *
     * @param other
     *         the other {@code ObservableMap}
    ...
    /**
     * Creates a {@link StringBinding} that holds the value of the {@code MapExpression} turned into a {@code String}.
     * If the value of this {@code MapExpression} changes, the value of the {@code StringBinding} will be updated
     * automatically.
     *
