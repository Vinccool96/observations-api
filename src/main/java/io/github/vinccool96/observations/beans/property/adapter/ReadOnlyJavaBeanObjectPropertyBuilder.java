...
/**
 * A {@code ReadOnlyJavaBeanObjectPropertyBuilder} can be used to create {@link ReadOnlyJavaBeanObjectProperty
 * ReadOnlyJavaBeanObjectProperties}. To create a {@code ReadOnlyJavaBeanObjectProperty} one first has to call {@link
