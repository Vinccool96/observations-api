...
/**
 * Base class that provides most of the functionality needed to implement a {@link Binding} of an {@code int} value.
 * <p>
 * {@code IntegerBinding} provides a simple invalidation-scheme. An extending class can register dependencies by calling
 * {@link #bind(Observable...)}. If one of the registered dependencies becomes invalid, this {@code IntegerBinding} is
...
public abstract class IntegerBinding extends IntegerExpression implements NumberBinding {
     ...
     * <p>
     * Classes extending {@code IntegerBinding} have to provide an implementation of {@code computeValue}.
     *
     * @return the current value
     */
