...
/**
 * A {@code ReadOnlyJavaBeanStringPropertyBuilder} can be used to create {@link ReadOnlyJavaBeanStringProperty
 * ReadOnlyJavaBeanStringProperties}. To create a {@code ReadOnlyJavaBeanStringProperty} one first has to call {@link
 ...
 * ReadOnlyJavaBeanStringPropertyBuilder}. by switching the Java Bean instance (with {@link #bean(Object)} and calling
 * {@link #build()}.
 *
...
public final class ReadOnlyJavaBeanStringPropertyBuilder {
     ...
     *         if the Java Bean property is not of type {@code String}
     */
