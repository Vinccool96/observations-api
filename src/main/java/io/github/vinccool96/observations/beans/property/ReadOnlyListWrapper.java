...
import static io.github.vinccool96.observations.collections.ListChangeListener.Change;
...
public class ReadOnlyListWrapper<E> extends SimpleListProperty<E> {
    ...
    /**
     * Returns the readonly property, that is synchronized with this {@code ReadOnlyListWrapper}.
     *
