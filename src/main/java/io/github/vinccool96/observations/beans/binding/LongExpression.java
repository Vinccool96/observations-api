...
/**
 * A {@code LongExpression} is a {@link ObservableLongValue} plus additional convenience methods to generate bindings in
 * a fluent style.
 * <p>
 * A concrete sub-class of {@code LongExpression} has to implement the method {@link ObservableLongValue#get()}, which
...
public abstract class LongExpression extends NumberExpressionBase implements ObservableLongValue {
    ...
    /**
     * Returns a {@code LongExpression} that wraps a {@link ObservableLongValue}. If the {@code ObservableLongValue} is
     * already a {@code LongExpression}, it will be returned. Otherwise a new {@link LongBinding} is created that is
     * bound to the {@code ObservableLongValue}.
     *
     * @param value
     *         The source {@code ObservableLongValue}
     *
     * @return A {@code LongExpression} that wraps the {@code ObservableLongValue} if necessary
     *
    ...
    /**
     * Returns a {@code LongExpression} that wraps an {@link ObservableValue}. If the {@code ObservableValue} is already
     * a {@code LongExpression}, it will be returned. Otherwise a new {@link LongBinding} is created that is bound to
     * the {@code ObservableValue}.
     *
     * <p>
     * Note: this method can be used to convert an {@link ObjectExpression} or {@link
     * io.github.vinccool96.observations.beans.property.ObjectProperty} of specific number type to LongExpression, which
    ...
    /**
     * Creates an {@link ObjectExpression} that holds the value of this {@code LongExpression}. If the value of this
     * {@code LongExpression} changes, the value of the {@code ObjectExpression} will be updated automatically.
     *
