...
/**
 * A {@code JavaBeanLongPropertyBuilder} can be used to create {@link JavaBeanLongProperty JavaBeanLongProperties}. To
 * create a {@code JavaBeanLongProperty} one first has to call {@link #create()} to generate a builder, set the required
 * properties, and then one can call {@link #build()} to generate the property.
 * <p>
 ...
 * JavaBeanLongPropertyBuilder}. by switching the Java Bean instance (with {@link #bean(Object)} and calling {@link
 * #build()}.
 *
