...
/**
 * A {@code ObjectExpression} is a {@link ObservableObjectValue} plus additional convenience methods to generate
...
public abstract class ObjectExpression<T> implements ObservableObjectValue<T> {
    ...
    /**
     * Returns an {@code ObjectExpression} that wraps an {@link ObservableObjectValue}. If the {@code
     * ObservableObjectValue} is already an {@code ObjectExpression}, it will be returned. Otherwise a new {@link
     * ObjectBinding} is created that is bound to the {@code ObservableObjectValue}.
     *
     * @param value
    ...
    public static <T> ObjectExpression<T> objectExpression(final ObservableObjectValue<T> value) {
        ...
        return value instanceof ObjectExpression ? (ObjectExpression<T>) value : new ObjectBinding<T>() {
    ...
    /**
     * Creates a new {@code BooleanExpression} that holds {@code true} if this and another {@link ObservableObjectValue}
     * are equal.
     *
     * @param other
    ...
    /**
     * Creates a new {@code BooleanExpression} that holds {@code true} if this {@code ObjectExpression} is equal to a
     * constant value.
     *
     * @param other
     *         the constant value
    ...
    /**
     * Creates a new {@code BooleanExpression} that holds {@code true} if this {@code ObjectExpression} is not equal to
     * a constant value.
     *
     * @param other
     *         the constant value
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code ObjectExpression} is {@code null}.
     *
    ...
    /**
     * Creates a new {@link BooleanBinding} that holds {@code true} if this {@code ObjectExpression} is not {@code
     * null}.
     *
     * @return the new {@code BooleanBinding}
     */
    ...
    /**
     * Creates a {@link StringBinding} that holds the value of this {@code ObjectExpression} turned into a {@code
     * String}. If the value of this {@code ObjectExpression} changes, the value of the {@code StringBinding} will be
    ...
    /**
     * Creates a {@link StringBinding} that holds the value of the {@code ObjectExpression} turned into a {@code
     * String}. If the value of this {@code ObjectExpression} changes, the value of the {@code StringBinding} will be
     * updated automatically.
     * <p>
