...
/**
 * A {@code ReadOnlyJavaBeanFloatPropertyBuilder} can be used to create {@link ReadOnlyJavaBeanFloatProperty
 * ReadOnlyJavaBeanFloatProperties}. To create a {@code ReadOnlyJavaBeanFloatProperty} one first has to call {@link
 ...
 * ReadOnlyJavaBeanFloatPropertyBuilder}. by switching the Java Bean instance (with {@link #bean(Object)} and calling
 * {@link #build()}.
 *
