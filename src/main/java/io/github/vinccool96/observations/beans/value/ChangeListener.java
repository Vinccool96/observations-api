...
/**
 * A {@code ChangeListener} is notified whenever the value of an {@link ObservableValue} changes. It can be registered
 * and unregistered with {@link ObservableValue#addListener(ChangeListener)} respectively {@link
...
public interface ChangeListener<T> {
    ...
    /**
     * This method needs to be provided by an implementation of {@code ChangeListener}. It is called if the value of an
