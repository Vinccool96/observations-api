...
import io.github.vinccool96.observations.beans.value.WritableIntegerValue;
 ...
 * <p>
 * The value of an {@code IntegerProperty} can be get and set with {@link #get()}, {@link #getValue()}, {@link
 * #set(int)}, and {@link #setValue(Number)}.
 * <p>
...
public abstract class IntegerProperty extends ReadOnlyIntegerProperty
     ...
     *
     * @return A {@code IntegerProperty} that wraps the {@code Property}
     *
