...
import io.github.vinccool96.observations.beans.value.WritableLongValue;
 ...
 * <p>
 * The value of a {@code LongProperty} can be get and set with {@link #get()}, {@link #getValue()}, {@link #set(long)},
 * and {@link #setValue(Number)}.
 * <p>
...
public abstract class LongProperty extends ReadOnlyLongProperty implements Property<Number>, WritableLongValue {
     ...
     *
     * @return A {@code LongProperty} that wraps the {@code Property}
     *
