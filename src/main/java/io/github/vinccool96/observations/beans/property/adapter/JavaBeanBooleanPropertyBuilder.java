...
/**
 * A {@code JavaBeanBooleanPropertyBuilder} can be used to create {@link JavaBeanBooleanProperty
 * JavaBeanBooleanProperties}. To create a {@code JavaBeanBooleanProperty} one first has to call {@link #create()} to
 ...
 * JavaBeanBooleanPropertyBuilder}. by switching the Java Bean instance (with {@link #bean(Object)} and calling {@link
 * #build()}.
 *
