...
/**
 * A {@code JavaBeanStringPropertyBuilder} can be used to create {@link JavaBeanStringProperty
 * JavaBeanStringProperties}. To create a {@code JavaBeanStringProperty} one first has to call {@link #create()} to
 ...
 * JavaBeanStringPropertyBuilder}. by switching the Java Bean instance (with {@link #bean(Object)} and calling {@link
 * #build()}.
 *
