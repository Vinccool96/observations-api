...
import io.github.vinccool96.observations.beans.binding.SetExpression;
...
public abstract class ReadOnlySetProperty<E> extends SetExpression<E> implements ReadOnlyProperty<ObservableSet<E>> {
    ...
    /**
     * Creates a bidirectional content binding of the {@link ObservableSet}, that is wrapped in this {@code
     * ReadOnlySetProperty}, and another {@code ObservableSet}.
     * <p>
     * A bidirectional content binding ensures that the content of two {@code ObservableSets} is the same. If the
     * content of one of the sets changes, the other one will be updated automatically.
     *
     * @param set
     *         the {@code ObservableSet} this property should be bound to
     *
     * @throws NullPointerException
     *         if {@code set} is {@code null}
     * @throws IllegalArgumentException
     *         if {@code set} is the same set that this {@code ReadOnlySetProperty} points to
     */
    ...
    /**
     * Deletes a bidirectional content binding between the {@link ObservableSet}, that is wrapped in this {@code
     * ReadOnlySetProperty}, and another {@code Object}.
     *
     * @param object
     ...
     * @throws IllegalArgumentException
     *         if {@code object} is the same set that this {@code ReadOnlySetProperty} points to
     */
    ...
    /**
     * Deletes a content binding between the {@link ObservableSet}, that is wrapped in this {@code ReadOnlySetProperty},
     * and another {@code Object}.
     *
     * @param object
