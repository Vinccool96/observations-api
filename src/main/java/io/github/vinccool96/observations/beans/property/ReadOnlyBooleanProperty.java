...
import io.github.vinccool96.observations.beans.binding.BooleanExpression;
...
public abstract class ReadOnlyBooleanProperty extends BooleanExpression implements ReadOnlyProperty<Boolean> {
    ...
    /**
     * Returns a {@code ReadOnlyBooleanProperty} that wraps a {@link ReadOnlyProperty}. If the {@code ReadOnlyProperty}
     * is already a {@code ReadOnlyBooleanProperty}, it will be returned. Otherwise a new {@code
     * ReadOnlyBooleanProperty} is created that is bound to the {@code ReadOnlyProperty}.
     * <p>
     ...
     *
     * @return A {@code ReadOnlyBooleanProperty} that wraps the {@code ReadOnlyProperty} if necessary
     *
    ...
    /**
     * Creates a {@link ReadOnlyObjectProperty} that holds the value of this {@code ReadOnlyBooleanProperty}. If the
     * value of this {@code ReadOnlyBooleanProperty} changes, the value of the {@code ReadOnlyObjectProperty} will be
