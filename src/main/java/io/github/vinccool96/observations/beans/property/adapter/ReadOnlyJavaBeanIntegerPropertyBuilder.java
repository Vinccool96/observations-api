...
/**
 * A {@code ReadOnlyJavaBeanIntegerPropertyBuilder} can be used to create {@link ReadOnlyJavaBeanIntegerProperty
 * ReadOnlyJavaBeanIntegerProperties}. To create a {@code ReadOnlyJavaBeanIntegerProperty} one first has to call {@link
 ...
 * ReadOnlyJavaBeanIntegerPropertyBuilder}. by switching the Java Bean instance (with {@link #bean(Object)} and calling
 * {@link #build()}.
 *
