...
/**
 * A {@code DoubleExpression} is a {@link ObservableDoubleValue} plus additional convenience methods to generate
...
public abstract class DoubleExpression extends NumberExpressionBase implements ObservableDoubleValue {
    ...
    /**
     * Returns a {@code DoubleExpression} that wraps a {@link ObservableDoubleValue}. If the {@code
     * ObservableDoubleValue} is already a {@code DoubleExpression}, it will be returned. Otherwise a new {@link
     * DoubleBinding} is created that is bound to the {@code ObservableDoubleValue}.
     *
     * @param value
     *         The source {@code ObservableDoubleValue}
     *
     * @return A {@code DoubleExpression} that wraps the {@code ObservableDoubleValue} if necessary
     *
    ...
    /**
     * Returns a {@code DoubleExpression} that wraps an {@link ObservableValue}. If the {@code ObservableValue} is
     * already a {@code DoubleExpression}, it will be returned. Otherwise a new {@link DoubleBinding} is created that is
     * bound to the {@code ObservableValue}.
     *
     * <p>
     * Note: this method can be used to convert an {@link ObjectExpression} or {@link
     * io.github.vinccool96.observations.beans.property.ObjectProperty} of specific number type to DoubleExpression,
    ...
    /**
     * Creates an {@link ObjectExpression} that holds the value of this {@code DoubleExpression}. If the value of this
     * {@code DoubleExpression} changes, the value of the {@code ObjectExpression} will be updated automatically.
     *
