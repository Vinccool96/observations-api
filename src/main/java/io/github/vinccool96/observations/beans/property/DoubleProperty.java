 ...
 * <p>
 * The value of a {@code DoubleProperty} can be get and set with {@link #get()}, {@link #getValue()}, {@link
 * #set(double)}, and {@link #setValue(Number)}.
 * <p>
...
public abstract class DoubleProperty extends ReadOnlyDoubleProperty implements Property<Number>, WritableDoubleValue {
     ...
     *
     * @return A {@code DoubleProperty} that wraps the {@code Property}
     *
