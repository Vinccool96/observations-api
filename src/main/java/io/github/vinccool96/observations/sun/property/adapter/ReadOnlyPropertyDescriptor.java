...
public class ReadOnlyPropertyDescriptor {
    ...
    public ReadOnlyPropertyDescriptor(String propertyName, Class<?> beanClass, Method getter) {
        ...
        try {
            ...
            try {
                tmpAddChangeListener =
                        beanClass.getMethod(ADD_LISTENER_METHOD_NAME, String.class, PropertyChangeListener.class);
        ...
        try {
            ...
            try {
                tmpRemoveChangeListener =
                        beanClass.getMethod(REMOVE_LISTENER_METHOD_NAME, String.class, PropertyChangeListener.class);
                tmpFlags |= REMOVE_LISTENER_TAKES_NAME;
            } catch (NoSuchMethodException e1) {
                try {
                    tmpRemoveChangeListener =
                            beanClass.getMethod(REMOVE_LISTENER_METHOD_NAME, PropertyChangeListener.class);
                } catch (NoSuchMethodException e2) {
                    // ignore
                }
            }
