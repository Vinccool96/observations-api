...
public final class PropertyReference<T> {
    ...
    /**
     * Returns the type of the property. This type is only evaluated correctly if a getter or a setter was found.
     *
     ...
     *
     * @param bean
     *         The {@code Bean} instance for which the property should be read
     *
    ...
    /**
     * Get the {@link io.github.vinccool96.observations.beans.value.ObservableValue} implementation of the property.
     *
     * @param bean
     *         The {@code Bean} instance for which the property should be read
     *
