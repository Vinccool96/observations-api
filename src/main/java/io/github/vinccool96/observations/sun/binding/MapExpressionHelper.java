...
/**
 * A convenience class for creating implementations of {@link io.github.vinccool96.observations.beans.value.ObservableValue}.
 ...
 * thread-safe.
 * <p>
 * For the {@code ExpressionHelperBase} that is used with the {@link ObservableMap ObservableMaps} created with the
 * methods of {@link io.github.vinccool96.observations.collections.ObservableCollections}, please refer to {@link
 * io.github.vinccool96.observations.sun.collections.MapListenerHelper}.
 */
...
public abstract class MapExpressionHelper<K, V> extends ExpressionHelperBase {
    ...
    public static <K, V> MapExpressionHelper<K, V> addListener(MapExpressionHelper<K, V> helper,
            ObservableMapValue<K, V> observable, InvalidationListener listener) {
    ...
    public static <K, V> MapExpressionHelper<K, V> removeListener(MapExpressionHelper<K, V> helper,
    ...
    public static <K, V> MapExpressionHelper<K, V> addListener(MapExpressionHelper<K, V> helper,
            ObservableMapValue<K, V> observable, ChangeListener<? super ObservableMap<K, V>> listener) {
        if ((observable == null) || (listener == null)) {
            throw new NullPointerException();
        }
    ...
    public static <K, V> MapExpressionHelper<K, V> addListener(MapExpressionHelper<K, V> helper,
            ObservableMapValue<K, V> observable, MapChangeListener<? super K, ? super V> listener) {
        if ((observable == null) || (listener == null)) {
            throw new NullPointerException();
        }
    ...
    public abstract ChangeListener<? super ObservableMap<K, V>>[] getChangeListeners();
    ...
    private static class SingleInvalidation<K, V> extends MapExpressionHelper<K, V> {
        ...
        @Override
        public ChangeListener<? super ObservableMap<K, V>>[] getChangeListeners() {
    ...
    private static class SingleChange<K, V> extends MapExpressionHelper<K, V> {
        ...
        private SingleChange(ObservableMapValue<K, V> observable,
                ChangeListener<? super ObservableMap<K, V>> listener) {
            super(observable);
            this.listener = listener;
    ...
    private static class SingleMapChange<K, V> extends MapExpressionHelper<K, V> {
        ...
        @Override
        protected void fireValueChangedEvent(final Change<? extends K, ? extends V> change) {
    ...
    private static class Generic<K, V> extends MapExpressionHelper<K, V> {
        ...
        private Generic(ObservableMapValue<K, V> observable, InvalidationListener listener0,
        ...
        private Generic(ObservableMapValue<K, V> observable, ChangeListener<? super ObservableMap<K, V>> listener0,
                ChangeListener<? super ObservableMap<K, V>> listener1) {
            super(observable);
        ...
        private Generic(ObservableMapValue<K, V> observable, MapChangeListener<? super K, ? super V> listener0,
        ...
        private Generic(ObservableMapValue<K, V> observable, InvalidationListener invalidationListener,
                ChangeListener<? super ObservableMap<K, V>> changeListener) {
            super(observable);
        ...
        private Generic(ObservableMapValue<K, V> observable, InvalidationListener invalidationListener,
                MapChangeListener<? super K, ? super V> listChangeListener) {
            super(observable);
            this.invalidationListeners = new InvalidationListener[]{invalidationListener};
            this.invalidationSize = 1;
        ...
        private void notifyListeners(ObservableMap<K, V> oldValue, SimpleChange<K, V> change) {
            ...
            final MapChangeListener<? super K, ? super V>[] curMapChangeList = mapChangeListeners;
            final int curMapChangeSize = mapChangeSize;
            try {
                locked = true;
                ...
                if (currentValue != oldValue || change != null) {
                    ...
                    if (curMapChangeSize > 0) {
                        if (change != null) {
                            for (int i = 0; i < curMapChangeSize; i++) {
                                curMapChangeList[i].onChanged(change);
                            }
                        } else {
    ...
    public static class SimpleChange<K, V> extends Change<K, V> {
        ...
        public SimpleChange(ObservableMap<K, V> set, Change<? extends K, ? extends V> source) {
            super(set);
            key = source.getKey();
