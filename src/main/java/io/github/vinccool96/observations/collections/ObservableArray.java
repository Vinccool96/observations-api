...
/**
 * {@code ObservableArray} is an array that allows listeners to track changes when they occur. In order to track
...
public interface ObservableArray<T extends ObservableArray<T>> extends Observable {
    ...
    /**
     * Grows the capacity of this array if the current capacity is less than given {@code capacity}, does nothing if it
