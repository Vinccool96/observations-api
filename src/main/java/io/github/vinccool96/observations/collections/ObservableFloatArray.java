...
/**
 * {@code ObservableFloatArray} is a {@code float[]} array that allows listeners to track changes when they occur. In
...
public interface ObservableFloatArray extends ObservableArray<ObservableFloatArray> {
     ...
     * float[], int, int)} update method instead with as minimum number of invocations as possible.
     *
     * @param index
     ...
     *
     * @param dest
     *         the array into which the observable array to be copied, if it is big enough; otherwise, a new float array
     ...
     *         otherwise, a new float array is allocated. Ignored, if null.
     * @param length
     *         length of portion to copy
     *
