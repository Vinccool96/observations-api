...
public abstract class TransformationList<E, F> extends ObservableListBase<E> implements ObservableList<E> {
    ...
    /**
     * This field contains the result of expression "source instanceof {@link ObservableList}". If this is true, it is
    ...
    /**
     * Checks whether the provided list is in the chain under this {@code TransformationList}.
     * <p>
     * This means the list is either the direct source as returned by {@link #getSource()} or the direct source is a
     * {@code TransformationList}, and the list is in it's transformation chain.
     *
     * @param list
     *         the list to check
     *
