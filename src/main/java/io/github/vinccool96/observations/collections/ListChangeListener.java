...
public interface ListChangeListener<E> {
    ...
    abstract class Change<E> {
        ...
        /**
         * Go to the next change. The Change in the initial state is invalid a requires a call to next() before calling
         * other methods. The first next() call will make this object represent the first change.
         *
         ...
         * interval marks the values that were permutated. If wasRemoved is true and wasAdded is false, getFrom() and
         * getTo() should return the same number - the place where the removed elements were positioned in the list.
         *
         ...
         * wasRemoved() returning true. See {@link #wasReplaced()}.
         *
         ...
         * in the example {@link Change above}, will effectively handle also set operation.
         *
         ...
         * is actually a shortcut to <code>c.getList().subList(c.getFrom(), c.getTo());</code><br>
         *
         * <pre><code>
         ...
         * return an array safely. The 0 index of the array corresponds to index {@link #getFrom()} of the list. The
         * same applies for the last index and {@link #getTo()}. The method is used by {@link #wasPermutated() } and
         * {@link #getPermutation(int)} methods.
         *
         ...
         * </pre>
         * <p>
         * Note: default implementation of this method takes the information from {@link #getPermutation()} method. You
