...
import io.github.vinccool96.observations.sun.collections.ChangeHelper;

import java.util.*;
import java.util.Map.Entry;

@SuppressWarnings({"ForLoopReplaceableByForEach", "unchecked", "rawtypes", "FieldMayBeFinal"})
        ...
        public String toString() {
            ...
            while (c < changes.length) {
                if (changes[c].perm.length != 0) {
                    ...
                    b.append(ChangeHelper
                            .addRemoveChangeToString(changes[c].from, changes[c].to, getList(), changes[c].removed));
                }
